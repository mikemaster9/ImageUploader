(function($) {
    ...
    class ImageUploader {
        constructor(container, options = {}) {
            ...
            // 默认配置，添加 useViewer 选项
            this.options = $.extend({
                maxSize: 5 * 1024 * 1024, // 5MB
                maxCount: 9, // 最大上传数量
                uploadUrl: '', // 上传接口地址
                showUploadButton: true, // 是否显示上传按钮
            ...
            this.mainViewer = null; // 主列表的 Viewer 实例
            this.dialogViewer = null; // 弹窗预览的 Viewer 实例
        ...
        injectStyles() {
            ...
            const styles = `
                ...
                .iu-image-item { width: 64px; height: 64px; border-radius: 4px; overflow: hidden; background-color: #f5f5f5; position: relative; }
                ...
                .iu-add-button { width: 64px; height: 64px; border: 2px dashed #ddd; border-radius: 4px; background: transparent; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.2s ease; position: relative; }
                ...
                .iu-preview-item { width: 64px; height: 64px; position: relative; flex-shrink: 0; }
        ...
        initDOM() {
            ...
            this.$container.html(`
                ...
                <div class="iu-image-list" id="iu-image-list">
                    ${this.options.showUploadButton ? '<button type="button" class="iu-add-button" id="iu-upload-trigger"></button>' : ''}
                </div>
